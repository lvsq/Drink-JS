...
class SundayServer{
  constructor(logger, config){
    ...
    this.server = null;
    //this.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js socket_server.address '+socket_server.address(), color:null}],0);
  ...
  function is_valid_opcode(opcode){
  ...
  function set_machine_server(machine_server){
