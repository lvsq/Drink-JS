...
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' - Server.js Sunday Server', color:null}],0);
var sunday_serv = net.Server();
var sunday = new SundayServer(sunday_serv, logger, config, config.sunday);/*sunday: {host: 'ip address',port: 4242},*/
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' -----------------------------------------------------------------------', color:null}],0);
// SSL connection. 4243
...
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' - Server.js Sunday Server create & set machine server', color:null}],0);
...
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' - Server.js Machine Server Init', color:null}],0);
machine_server.init();
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' -----------------------------------------------------------------------', color:null}],0);

// 4). init the sunday server
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' - Server.js Sunday Init', color:null}],0);
sunday.init();
logger.log([{msg: utils.get_time(), color: 'green'},{msg: ' -----------------------------------------------------------------------', color:null}],0);
