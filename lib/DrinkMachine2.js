...
class DrinkMachine {
  ...
  prep_command(request_obj){
    ...
    if(typeof data == 'undefined'){
      ...
      self.logger.log([{msg: self.machine_time(), color: 'cyan'}, {msg:' - typeof data == undefined', color: null}], 0);
      data = {};
      console.console.log("after "+data);
    }
    console.console.log(self.requesting);

    if(self.requesting == false){
      self.logger.log([{msg: self.machine_time(), color: 'cyan'}, {msg:' - self.requesting == false', color: null}], 0);
