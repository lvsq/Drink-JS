...
SundayServer.prototype = {
    ...
    init: function(){
        ...
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js Listening on '+self.sunday_config.port +' '+self.sunday_config.host + "server listening: "+ self.server.listening, color:null}],0);
