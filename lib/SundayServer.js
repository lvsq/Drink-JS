...
SundayServer.prototype = {
    ...
    init: function(){
        ...
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js '+self.server.address(), color:null}],0);
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js Server Listening: '+ self.server.listening +' '+self.sunday_config.host+':'+typeof(self.sunday_config.port), color:null}],0);
