...
SundayServer.prototype = {
    ...
    send_msg_code: function(code, socket, message){
        logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js send_msg_code', color:null}],0);
        var self = this;
    ...
    send_json_msg: function(socket, payload){
        logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js is_valid_opcode send_json_msg', color:null}],0);
        var self = this;
