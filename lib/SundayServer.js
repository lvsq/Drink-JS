...
SundayServer.prototype = {
    ...
    init: function(){
        ...
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js '+self.server.address().address, color:null}],0);
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js '+self.server.address().port, color:null}],0);
