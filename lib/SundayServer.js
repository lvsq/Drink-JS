...
SundayServer.prototype = {
    ...
    init: function(){
        ...
        self.server.on('connection', function(socket){
            ...
            self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js init connection', color:null}],0);
        });
        self.logger.log([{msg: utils.get_time(), color: 'red'},{msg: ' - Sunday Server.js init', color:null}],0);
    },
