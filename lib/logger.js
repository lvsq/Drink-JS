...
/**
 * Logger
 * Facilitates custom logging to the console, to a database, and to a file.
 * TODO: Implement functinality for database.
 * TODO: Implement functionality for file.
 */
class Logger {
  constructor() {
    var self = this;
